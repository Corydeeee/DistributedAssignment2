...
#include "splitutility.h"
#include "mergutility.h"
...
void masterWakeupUser() {
    ...
    char *tmp = calloc(0, sizeof(char)*2);
...
void userRoutine() {
    ...
    printf("Wait for processes to complete.\n");
...
void initMapTasks() {
    ...
    mapTasksCount = splitfile("/Volumes/10T/Mapper/input.txt");
